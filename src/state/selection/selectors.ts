...
export const getNumberCollapsed = (state: State) => state.selection.numberPanelsCollapsed;
export const getHightlightedId = (state: State) => state.selection.hightlightedId;
// COMPOSED SELECTORS
